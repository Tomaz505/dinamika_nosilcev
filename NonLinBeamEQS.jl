...
begin
	...
	u0 = substitute.(u,t=>t0)
	um = substitute.(u,t=>t0)+v*(h/2)
	u1 = substitute.(u,t=>t0)+v*(h)

	
	d0 = expand_derivatives.(dx.(u0) + [cos(φ₀), sin(φ₀), 0])
	dm = expand_derivatives.(dx.(um) + [cos(φ₀), sin(φ₀), 0])
	d1 = expand_derivatives.(dx.(u1) + [cos(φ₀), sin(φ₀), 0])



	R0 = [cos(u0[3]) -sin(u0[3]) 0; sin(u0[3]) cos(u0[3]) 0; 0 0 1]
...
manifest_format = "2.0"
project_hash = "90a138e42eab6373978426341a621f6d4c89944e"
