...
# ╔═╡ f9f6abc5-9990-475a-9ecd-01d1aeb1262a
begin
	using Plots, SparseArrays,LinearAlgebra, PlutoUI
	include("NonLinBeamMOD.jl")
	using .NonLinBeam
end

# ╔═╡ ab0d8dc3-bf97-44b3-8558-e476ee638209
include("NonLinBeamRUN.jl")

# ╔═╡ f046f998-8a91-11f0-2c7f-5187b46070db
run(`ls`)

# ╔═╡ 7db9e8ca-1412-4ce7-84ad-9d6db520182e
@bind RUN CheckBox(default=true)

# ╔═╡ ad9bda83-86b9-4042-b792-b0f456e1b6f5
file = "in/test1"
...
manifest_format = "2.0"
project_hash = "a227f834a9d021116a0db1e5d237f52218235bb5"
